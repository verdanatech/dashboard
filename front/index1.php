...
switch (date("w")) {
	case "0":
		$dia = __('Sunday', 'dashboard');
		break;
	case "1":
		$dia = __('Monday', 'dashboard');
		break;
	case "2":
		$dia = __('Tuesday', 'dashboard');
		break;
	case "3":
		$dia = __('Wednesday', 'dashboard');
		break;
	case "4":
...
<div class="site-holder">
						...
						<div class="yamm-content" style="width:400px;">
							<div class="row">
								<ul class="col-sm-2 list-unstyled menu1" style="width:180px;">
									...
									<li><a href="./reports/rel_grupos_vol.php?con=1" target="iframe1"> <?php echo _sn('Group', 'Groups', 2) . " por Volume"; ?> </a></li>
								...
								<ul class="col-sm-2 list-unstyled menu1" style="width:180px;">
									...
									<li><a href="./reports/rel_slanew.php" target="iframe1" style="color:#000;"><?php echo __('Relatório SLA'); ?></a></li>
				</li>
	...
	<li class="dropdown menu"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1"><i class='fa fa-line-chart'></i>&nbsp;<?php echo __('Metrics', 'dashboard'); ?>&nbsp;<b class="caret"></b></span></a>
		<ul role="menu" class="dropdown-menu">
			...
			<li><a tabindex="-1" href="./metrics/dashboardsla.php" target="_blank"> <?php echo __('by SLA', 'dashboard'); ?> </a></li>
		</ul>
	</li>
