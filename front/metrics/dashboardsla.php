                ...
                success: function(response) {
                    ...
                    if (groups != 0) {
                        ...
                        $.each(groups, (index, grupo) => {
                            ...
                            if (chamado == 0 & groups != 0) {
                                link_muito_alto += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=5&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=1`;
                                link_medio += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=3&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=1`;
                                link_alto += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][3][link]=AND&criteria[${index}][criteria][3][field]=82&criteria[${index}][criteria][3][searchtype]=equals&criteria[${index}][criteria][3][value]=0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=4&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=1`;
                                link_baixo += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][3][link]=AND&criteria[${index}][criteria][3][field]=82&criteria[${index}][criteria][3][searchtype]=equals&criteria[${index}][criteria][3][value]=0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=2&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=1`;
                                link_requisicao += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][3][link]=AND&criteria[${index}][criteria][3][field]=82&criteria[${index}][criteria][3][searchtype]=equals&criteria[${index}][criteria][3][value]=0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=14&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=2`
                                link_incidente += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][3][link]=AND&criteria[${index}][criteria][3][field]=82&criteria[${index}][criteria][3][searchtype]=equals&criteria[${index}][criteria][3][value]=0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=14&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=1`
                            } else if (chamado != 0 && groups != 0) {
                                link_muito_alto += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][3][link]=AND&criteria[${index}][criteria][3][field]=82&criteria[${index}][criteria][3][searchtype]=equals&criteria[${index}][criteria][3][value]=0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=5&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=${chamado}`;
                                link_medio += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][3][link]=AND&criteria[${index}][criteria][3][field]=82&criteria[${index}][criteria][3][searchtype]=equals&criteria[${index}][criteria][3][value]=0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=3&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=${chamado}`;
                                link_alto += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][3][link]=AND&criteria[${index}][criteria][3][field]=82&criteria[${index}][criteria][3][searchtype]=equals&criteria[${index}][criteria][3][value]=0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=4&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=${chamado}`;
                                link_baixo += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:0&criteria[${index}][criteria][3][link]=AND&criteria[${index}][criteria][3][field]=82&criteria[${index}][criteria][3][searchtype]=equals&criteria[${index}][criteria][3][value]=0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=2&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=${chamado}`;
                                link_requisicao += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][3][link]=AND&criteria[${index}][criteria][3][field]=82&criteria[${index}][criteria][3][searchtype]=equals&criteria[${index}][criteria][3][value]=0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=14&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=2`;
                                link_incidente += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][3][link]=AND&criteria[${index}][criteria][3][field]=82&criteria[${index}][criteria][3][searchtype]=equals&criteria[${index}][criteria][3][value]=0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=14&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=1`;
                            }
                        });
                    ...
                    if (groups != 0) {
                        ...
                        $.each(groups, (index, grupo) => {
                            ...
                            if (chamado == 0 & groups != 0) {
                                total_link_muito_alto += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=5&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=1`;
                                total_link_medio += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=3&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=1`;
                                total_link_alto += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=4&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=1`;
                                total_link_baixo += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=2&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=1`;
                                total_link_requisicao += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=14&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=2`
                                total_link_incidente += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=14&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=1`
                            } else if (chamado != 0 && groups != 0) {
                                total_link_muito_alto += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=5&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=${chamado}`;
                                total_link_medio += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=3&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=${chamado}`;
                                total_link_alto += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=4&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=${chamado}`;
                                total_link_baixo += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:0&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=11&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=2&criteria[${index}][criteria][9][field]=14&criteria[${index}][criteria][9][searchtype]=equals&criteria[${index}][criteria][9][value]=${chamado}`;
                                total_link_requisicao += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=14&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=2`;
                                total_link_incidente += `criteria[${index}][criteria][1][link]=AND&criteria[${index}][criteria][1][field]=16&criteria[${index}][criteria][1][searchtype]=morethan&criteria[${index}][criteria][1][value]=${res["data1"]}+00:00&criteria[${index}][criteria][5][link]=AND&criteria[${index}][criteria][5][field]=8&criteria[${index}][criteria][5][searchtype]=equals&criteria[${index}][criteria][5][value]=${grupo}&criteria[${index}][criteria][7][link]=AND&criteria[${index}][criteria][7][field]=16&criteria[${index}][criteria][7][searchtype]=lessthan&criteria[${index}][criteria][7][value]=${res["data2"]}+23:59&criteria[${index}][criteria][8][link]=AND&criteria[${index}][criteria][8][field]=14&criteria[${index}][criteria][8][searchtype]=equals&criteria[${index}][criteria][8][value]=1`;
                            }
                        });
                    ...
                    if (res['muito_alto'] == 0) {
                        ...
                        link_total_muito_alto = `<a target='_blank' href='<?php echo $CFG_GLPI['url_base'] ?>/front/ticket.php?is_deleted=0&as_map=0&criteria[0][link]=AND&criteria[0][field]=16&criteria[0][searchtype]=morethan&_select_criteria[0][value]=0&_criteria[0][value]=${res["data1"]}+00:00&criteria[0][value]=${res["data1"]}+00:00&criteria[1][link]=AND&criteria[1][field]=16&criteria[1][searchtype]=lessthan&_select_criteria[1][value]=0&_criteria[1][value]=${res["data2"]}+23:59&criteria[1][value]=${res["data2"]}+23:59:00&criteria[4][link]=AND&criteria[4][field]=11&criteria[4][searchtype]=equals&criteria[4][value]=5&criteria[6][link]=AND&criteria[6][field]=14&criteria[6][searchtype]=equals&criteria[6][value]=${chamado}&search=Pesquisar&itemtype=Ticket&start=0  target="__blank"'> ` + res['total_muito_alto'] + ` </a>`;
                    } else if (chamado == 0 && groups == 0) {
                        link_total_muito_alto = `<a target='_blank' href='<?php echo $CFG_GLPI['url_base'] ?>/front/ticket.php?is_deleted=0&as_map=0&criteria[0][link]=AND&criteria[0][criteria][1][link]=AND&criteria[0][criteria][1][field]=16&criteria[0][criteria][1][searchtype]=morethan&_select_criteria[0][criteria][1][value]=0&_criteria[0][criteria][1][value]=${res["data1"]}+00:00&criteria[0][criteria][1][value]=${res["data1"]}+00:00&criteria[0][criteria][7][link]=AND&criteria[0][criteria][7][field]=16&criteria[0][criteria][7][searchtype]=lessthan&_select_criteria[0][criteria][7][value]=0&_criteria[0][criteria][7][value]=${res["data2"]}+23:59&criteria[0][criteria][7][value]=${res["data2"]}+23:59&criteria[0][criteria][8][link]=AND&criteria[0][criteria][8][field]=11&criteria[0][criteria][8][searchtype]=equals&criteria[0][criteria][8][value]=5&criteria[0][criteria][9][field]=14&criteria[0][criteria][9][searchtype]=equals&criteria[0][criteria][9][value]=1&search=Pesquisar&itemtype=Ticket&start=0  target="__blank"'>` + res['total_muito_alto'] + ` </a>`;
                    } else {
                    ...
                    if (res['alto'] == 0) {
                        ...
                        link_total_alto = `<a target='_blank' href='<?php echo $CFG_GLPI['url_base'] ?>/front/ticket.php?is_deleted=0&as_map=0&criteria[0][link]=AND&criteria[0][criteria][1][link]=AND&criteria[0][criteria][1][field]=16&criteria[0][criteria][1][searchtype]=morethan&_select_criteria[0][criteria][1][value]=0&_criteria[0][criteria][1][value]=${res["data1"]}+00:00&criteria[0][criteria][1][value]=${res["data1"]}+00:00&criteria[0][criteria][7][link]=AND&criteria[0][criteria][7][field]=16&criteria[0][criteria][7][searchtype]=lessthan&_select_criteria[0][criteria][7][value]=0&_criteria[0][criteria][7][value]=${res["data2"]}+23:59&criteria[0][criteria][7][value]=${res["data2"]}+23:59&criteria[0][criteria][8][link]=AND&criteria[0][criteria][8][field]=11&criteria[0][criteria][8][searchtype]=equals&criteria[0][criteria][8][value]=4&criteria[0][criteria][9][field]=14&criteria[0][criteria][9][searchtype]=equals&criteria[0][criteria][9][value]=1&search=Pesquisar&itemtype=Ticket&start=0'>` + res['total_alto'] + ` </a>`;
                    } else {
                    ...
                    if (res['medio'] == 0) {
                        ...
                        link_total_medio = `<a target='_blank' href='<?php echo $CFG_GLPI['url_base'] ?>/front/ticket.php?is_deleted=0&as_map=0&criteria[0][link]=AND&criteria[0][criteria][1][link]=AND&criteria[0][criteria][1][field]=16&criteria[0][criteria][1][searchtype]=morethan&_select_criteria[0][criteria][1][value]=0&_criteria[0][criteria][1][value]=${res["data1"]}+00:00&criteria[0][criteria][1][value]=${res["data1"]}+00:00&criteria[0][criteria][7][link]=AND&criteria[0][criteria][7][field]=16&criteria[0][criteria][7][searchtype]=lessthan&_select_criteria[0][criteria][7][value]=0&_criteria[0][criteria][7][value]=${res["data2"]}+23:59&criteria[0][criteria][7][value]=${res["data2"]}+23:59&criteria[0][criteria][8][link]=AND&criteria[0][criteria][8][field]=11&criteria[0][criteria][8][searchtype]=equals&criteria[0][criteria][8][value]=3&criteria[0][criteria][9][field]=14&criteria[0][criteria][9][searchtype]=equals&criteria[0][criteria][9][value]=1&search=Pesquisar&itemtype=Ticket&start=0'>` + res['total_medio'] + ` </a>`;
                    } else {
                    ...
                    if (res['baixo'] == 0) {
                        ...
                        link_total_baixo = `<a target='_blank' href='<?php echo $CFG_GLPI['url_base'] ?>/front/ticket.php?is_deleted=0&as_map=0&criteria[0][link]=AND&criteria[0][criteria][1][link]=AND&criteria[0][criteria][1][field]=16&criteria[0][criteria][1][searchtype]=morethan&_select_criteria[0][criteria][1][value]=0&_criteria[0][criteria][1][value]=${res["data1"]}+00:00&criteria[0][criteria][1][value]=${res["data1"]}+00:00&criteria[0][criteria][7][link]=AND&criteria[0][criteria][7][field]=16&criteria[0][criteria][7][searchtype]=lessthan&_select_criteria[0][criteria][7][value]=0&_criteria[0][criteria][7][value]=${res["data2"]}+23:59&criteria[0][criteria][7][value]=${res["data2"]}+23:59&criteria[0][criteria][8][link]=AND&criteria[0][criteria][8][field]=11&criteria[0][criteria][8][searchtype]=equals&criteria[0][criteria][8][value]=2&criteria[0][criteria][9][field]=14&criteria[0][criteria][9][searchtype]=equals&criteria[0][criteria][9][value]=1&search=Pesquisar&itemtype=Ticket&start=0'>` + res['total_baixo'] + ` </a>`;
                    } else {
                    ...
                    // } else if (chamado != 0 && groups == 0) {
                    //     $("#graf01").attr("href", `<?php echo $CFG_GLPI['url_base'] ?>/front/ticket.php?is_deleted=0&as_map=0&criteria[0][link]=AND&criteria[0][field]=16&criteria[0][searchtype]=morethan&_select_criteria[0][value]=0&_criteria[0][value]=${res["data1"]}+00:00&criteria[0][value]=${res["data1"]}+00:00&criteria[1][link]=AND&criteria[1][field]=16&criteria[1][searchtype]=lessthan&_select_criteria[1][value]=0&_criteria[1][value]=${res["data2"]}+23:59&criteria[1][value]=${res["data2"]}+23:59:00&criteria[3][link]=AND&criteria[3][field]=82&criteria[3][searchtype]=equals&criteria[3][value]=0&criteria[4][link]=AND&criteria[4][field]=11&criteria[4][searchtype]=equals&criteria[4][value]=5&criteria[6][link]=AND&criteria[6][field]=14&criteria[6][searchtype]=equals&criteria[6][value]=${chamado}&search=Pesquisar&itemtype=Ticket&start=0`);
                    // } else if (chamado == 0 && groups == 0) {
                    //     $("#graf01").attr("href", `<?php echo $CFG_GLPI['url_base'] ?>/front/ticket.php?is_deleted=0&as_map=0&criteria[0][link]=AND&criteria[0][criteria][1][link]=AND&criteria[0][criteria][1][field]=16&criteria[0][criteria][1][searchtype]=morethan&_select_criteria[0][criteria][1][value]=0&_criteria[0][criteria][1][value]=${res["data1"]}+00:00&criteria[0][criteria][1][value]=${res["data1"]}+00:00&criteria[0][criteria][3][link]=AND&criteria[0][criteria][3][field]=82&criteria[0][criteria][3][searchtype]=equals&criteria[0][criteria][3][value]=0&criteria[0][criteria][7][link]=AND&criteria[0][criteria][7][field]=16&criteria[0][criteria][7][searchtype]=lessthan&_select_criteria[0][criteria][7][value]=0&_criteria[0][criteria][7][value]=${res["data2"]}+23:59&criteria[0][criteria][7][value]=${res["data2"]}+23:59&criteria[0][criteria][8][link]=AND&criteria[0][criteria][8][field]=11&criteria[0][criteria][8][searchtype]=equals&criteria[0][criteria][8][value]=5&search=Pesquisar&itemtype=Ticket&start=0`);
                    // } else {
