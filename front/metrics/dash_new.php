    ...
    function buscarDados(data1, data2, groups, sla, chamado, impacto) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                " target='_blank'style="font-size:10px">Abrir Chamados</a>`;
                $(`#graf5`).append(html);
                initGauge6(0, 100, ...res["incidente"])
